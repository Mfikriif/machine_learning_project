...
if st.button("Prediksi"):
    ...
    # Ambil kategori berdasarkan cluster
    category = cluster_mapping.get(predicted_cluster, "Unknown Category")
    
    # Tampilkan hasil prediksi
    st.subheader("Hasil Prediksi:")
    st.write(f"Data baru masuk ke cluster: {predicted_cluster} ({category})")
